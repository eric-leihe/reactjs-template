...
const defaultConfig = {
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            ...
            headHtmlSnippet: `
                <script>
                    // window.DISABLE__REACT_DEVTOOLS_GLOBAL_HOOK__ = (function(){
                    //     return {
                    //         inject: (renderer) => { console.log("renderer"); return "12" },
                    //         emit: (event, data) => { console.log(event + " : " + data) },
                    //         supportsFiber: true,
                    //         onCommitFiberRoot: (rendererID, root) => { console.log(rendererID + " : " + root) },
                    //         onCommitFiberUnmount: function(rendererID, fiber) {
                    //             console.log("onCommitFiberUnmount:" + rendererID)
                    //         },
                    //     }
                    // })()
                </script>`,
